...
Usage: pytest -v -s ./tests/test_vs.py
'''
...
class TestVS:
    ...
    '''Send a get_version APDU to the VS app.'''
    def test_vs_get_version(self, app):    
        pack = app.apduMessage(0x06,0x00,0x00,"FF")
        data, status = app.exchange(pack)
        assert(data[1:].hex() == "000105")


    def test_vs_get_addresses(self, app):
        for i in range(2):
    ...
    def test_vs_send_with_data_field(self, app):
        tx = app.packContract(
            vision.Transaction.Contract.TransferContract,
            contract.TransferContract(
                owner_address=bytes.fromhex(app.getAccount(0)['addressHex']),
            ...
            b'CryptoChain-VisionSR Ledger Transactions Tests'
        )
        data, status = app.sign(app.getAccount(0)['path'], tx)
        validSignature, txID = validateSignature.validate(tx,data[0:65],app.getAccount(0)['publicKey'][2:])
        assert(validSignature == True)
    ...
    def test_vs_send_wrong_path(self, app):
        tx = app.packContract(
            vision.Transaction.Contract.TransferContract,
            contract.TransferContract(
                owner_address=bytes.fromhex(app.getAccount(0)['addressHex']),
    ...
    def test_vs_send_asset_without_name(self, app):
        tx = app.packContract(
            vision.Transaction.Contract.TransferAssetContract,
    ...
    def test_vs_send_asset_with_name(self, app):
        tx = app.packContract(
            vision.Transaction.Contract.TransferAssetContract,
            contract.TransferAssetContract(
                owner_address=bytes.fromhex(app.getAccount(0)['addressHex']),
    ...
    def test_vs_send_asset_with_name_wrong_signature(self, app):
        tx = app.packContract(
            vision.Transaction.Contract.TransferAssetContract,
            contract.TransferAssetContract(
                owner_address=bytes.fromhex(app.getAccount(0)['addressHex']),
    ...
    def test_vs_exchange_create(self, app):
        tx = app.packContract(
            vision.Transaction.Contract.ExchangeCreateContract,
    ...
    def test_vs_exchange_create_with_token_name(self, app):
        tx = app.packContract(
            vision.Transaction.Contract.ExchangeCreateContract,
            contract.ExchangeCreateContract(
                owner_address=bytes.fromhex(app.getAccount(0)['addressHex']),
    ...
    def test_vs_exchange_inject(self, app):
        tx = app.packContract(
            vision.Transaction.Contract.ExchangeInjectContract,
    ...
    def test_vs_exchange_withdraw(self, app):
        tx = app.packContract(
            vision.Transaction.Contract.ExchangeWithdrawContract,
    ...
    def test_vs_exchange_transaction(self, app):
        tx = app.packContract(
            vision.Transaction.Contract.ExchangeTransactionContract,
    ...
    def test_vs_vote_witness(self, app):
        tx = app.packContract(
            vision.Transaction.Contract.VoteWitnessContract,
    ...
    def test_vs_vote_witness_more_than_5(self, app):
        tx = app.packContract(
            vision.Transaction.Contract.VoteWitnessContract,
            contract.VoteWitnessContract(
                owner_address=bytes.fromhex(app.getAccount(0)['addressHex']),
    ...
    def test_vs_freeze_balance_bw(self, app):
        tx = app.packContract(
            vision.Transaction.Contract.FreezeBalanceContract,
    ...
    def test_vs_freeze_balance_entropy(self, app):
        tx = app.packContract(
            vision.Transaction.Contract.FreezeBalanceContract,
            contract.FreezeBalanceContract(
                owner_address=bytes.fromhex(app.getAccount(0)['addressHex']),
    ...
    def test_vs_freeze_balance_delegate_entropy(self, app):
        tx = app.packContract(
            vision.Transaction.Contract.FreezeBalanceContract,
            contract.FreezeBalanceContract(
                owner_address=bytes.fromhex(app.getAccount(0)['addressHex']),
    ...
    def test_vs_unfreeze_balance_bw(self, app):
        tx = app.packContract(
    ...
    def test_vs_withdraw_balance(self, app):
        tx = app.packContract(
            vision.Transaction.Contract.WithdrawBalanceContract,
    ...
    def test_vs_proposal_approve(self, app):
        tx = app.packContract(
            vision.Transaction.Contract.ProposalApproveContract,
    ...
    def test_vs_proposal_delete(self, app):
        tx = app.packContract(
            vision.Transaction.Contract.ProposalDeleteContract,
    ...
    def test_vs_account_update(self, app):
        tx = app.packContract(
            vision.Transaction.Contract.AccountUpdateContract,
    ...
    def test_vs_vrc20_send(self, app):
        tx = app.packContract(
            vision.Transaction.Contract.TriggerSmartContract,
    ...
    def test_vs_vrc20_approve(self, app):
        tx = app.packContract(
            vision.Transaction.Contract.TriggerSmartContract,
            contract.TriggerSmartContract(
                owner_address=bytes.fromhex(app.getAccount(0)['addressHex']),
    ...
    def test_vs_sign_message(self, app):
        # Magic define
        SIGN_MAGIC = b'\x19Vision Signed Message:\n'
        message = 'CryptoChain-VisionSR Ledger Transactions Tests'.encode()
    ...
    def test_vs_custom_contract(self, app):
        tx = app.packContract(
            vision.Transaction.Contract.TriggerSmartContract,
            contract.TriggerSmartContract(
                owner_address=bytes.fromhex(app.getAccount(0)['addressHex']),
