...
typedef enum _protocol_ResourceCode {
    protocol_ResourceCode_PHOTON = 0,
    protocol_ResourceCode_ENTROPY = 1
...
#define _protocol_ResourceCode_MIN protocol_ResourceCode_PHOTON
#define _protocol_ResourceCode_MAX protocol_ResourceCode_ENTROPY
#define _protocol_ResourceCode_ARRAYSIZE ((protocol_ResourceCode)(protocol_ResourceCode_ENTROPY+1))
...
#define protocol_AssetIssueContract_vs_num_tag  6
...
X(a, STATIC,   SINGULAR, INT32,    vs_num,           6) \
